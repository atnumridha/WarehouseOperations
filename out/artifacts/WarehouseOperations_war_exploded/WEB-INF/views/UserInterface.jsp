...
<div class="wrapper">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active">
                            <a href="<c:url value="/Registration"/>"><i class="glyphicon glyphicon-user"></i>User Creation</a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Main Menu
                <small>Blank example to the Main Menu</small>
            </h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            <div class="callout callout-info">
                ...
                <p>Add the layout-boxed class to the body tag to get this layout. The Main Menu is helpful when working
                    on
