...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<c:url value="resources/bootstrap/iCheck/square/blue.css"/>">
...
<div class="register-box">
    <div class="register-logo">
        <a href="../../index2.html"><b>Warehouse</b>Operations</a>
    </div>
    ...
    <div class="register-box-body">
        ...
        <a href="<c:url value="/"/> "class="text-center">If already an user</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
...
<!-- iCheck -->
<script src="<c:url value="resources/bootstrap/iCheck/icheck.min.js"/>"></script>
<script>
    $(function () {
        $('input').iCheck({
